...
export const demoPosts: DemoPost[] = [
  {
    slug: "healthtech-architecture-nextjs-supabase",
    title: "Architecting Sub-Second HealthTech Portals with Next.js 15 & Supabase",
    excerpt:
    ...
    author_name: "Ahmad Sadiq",
    author_role: "Founder & Lead Solutions Architect",
    author_avatar: "/ahmad-sadiq.png",
    content:
  ...
  {
    slug: "interactive-motion-gsap-performance",
    title: "Achieving 60 FPS Interactive 3D Motion Without Sacrificing Lighthouse Scores",
    excerpt:
    ...
    tags: ["Design", "Animation", "Performance"],
    read_minutes: 7,
  ...
  {
    slug: "voice-ai-saas-streaming-pipelines",
    title: "Building Voice-First AI SaaS Applications with Next.js and Real-Time LLM Pipelines",
    excerpt:
...
export const demoServices: DemoService[] = [
  ...
  },
  {
    ...
    title: "7-Day High-Converting Landing Page Sprint",
    category: "Web & Engineering",
    short_desc: "Custom 60 FPS GSAP-animated landing page designed, coded, and launched in 7 days for product launches and waitlists.",
    long_desc: "We design, code, and deploy a bespoke, high-converting landing page for your product launch, waitlist, or agency in 7 business days. Built with Next.js 15, TailwindCSS, and fluid GSAP micro-animations that captivate visitors and drive conversions.\n\nIdeal for startup founders launching on Product Hunt or Twitter, SaaS waitlists, and businesses tired of generic, bloated WordPress templates that load slowly.\n\nYou walk away with a custom, lightning-fast landing page live on your custom domain, full waitlist/lead capture or Stripe integration, automated social sharing OpenGraph previews, and 100% full source code ownership.",
    starting_at: 1200,
    currency: "USD",
    features: [
    ...
    duration_note: "7 days delivery",
    is_active: true,
  },
  {
    slug: "figma-to-code",
    title: "Figma to Next.js & React Engineering",
    category: "Web & Engineering",
    short_desc: "Pixel-perfect, responsive React & Next.js frontend development directly from your Figma design files.",
    long_desc: "We turn your Figma design files into clean, pixel-perfect, production-grade Next.js and React code. We map your exact typography, colors, spacing, and design tokens into responsive, accessible code that works seamlessly across all devices.\n\nDesigned for digital design agencies, UI/UX freelancers, and product teams who already have beautiful Figma designs ready but need a reliable, senior frontend engineer to code them without compromises.\n\nYou walk away with a clean, modular TypeScript component architecture, fluid animations matching your design prototypes, sub-second page performance, and direct GitHub repository transfer.",
    starting_at: 1000,
    currency: "USD",
    features: [
  ...
  },
  {
    ...
    title: "72-Hour Website Speed & Core Web Vitals Rescue",
    category: "SEO & Marketing",
    short_desc: "Guaranteed 90+ Google Lighthouse score and sub-1.5s load speed for lagging Shopify, Next.js, and web stores.",
    long_desc: "We take your slow, lagging website or online store and perform an intensive 72-hour performance overhaul. We eliminate render-blocking scripts, compress heavy media assets, configure edge CDN caching, and resolve Google Core Web Vitals issues.\n\nFor online stores and business websites losing sales, ad spend, and Google search ranking because pages take 4 to 6 seconds to load on mobile devices.\n\nYou walk away with a guaranteed 90+ Google Lighthouse score, sub-1.5 second page load times, passing Core Web Vitals (LCP, CLS, INP), and an authentic before-and-after audit report.",
    starting_at: 700,
    currency: "USD",
    features: [
    ...
    duration_note: "72 hours delivery",
    is_active: true,
  },
];
...
export const demoQuotes: DemoQuote[] = [
  {
    client_name: "Saad Ali",
    role: "Founder",
    company: "PhysicianMeds",
    rating: 5,
    quote: "Nex Desk delivered beyond expectations. Our platform needed to handle complex medical billing workflows while looking world-class — they nailed both. The animations are smooth, the backend is solid, and the whole project was delivered on time.",
  },
  {
    client_name: "James Carter",
    role: "Creative Director",
    company: "Studio Velvet UK",
    rating: 5,
    quote: "I gave them a creative brief and they turned it into something extraordinary. The GSAP animations on Velvet Pour feel cinematic and luxury. They have a rare ability to combine high-end design with rock-solid code.",
  },
  {
    client_name: "Sarah Mitchell",
    role: "Product Manager",
    company: "Converso AI (US)",
    rating: 5,
    quote: "Building an AI SaaS product is complex, but Nex Desk made it look seamless. The voice companion feature works flawlessly, the UI is clean, and the Supabase architecture is rock solid. Delivered on schedule.",
  },

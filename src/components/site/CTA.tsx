...
/**
 * Centered CTA — clean, symmetrical, no side-cards.
 * Label → headline → inline stat pills → two buttons.
 */
  ...
  return (
    <section className="shell py-10">
      <div className="relative overflow-hidden rounded-3xl bg-ink-900 px-8 py-20 text-center sm:px-16">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-0 h-56 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-lime-400 opacity-[0.12] blur-3xl"
        />

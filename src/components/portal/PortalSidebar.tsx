...
export default function PortalSidebar({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-0 z-40 bg-ink-950/80 backdrop-blur-sm transition-opacity duration-500 lg:hidden",
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-ink-600 bg-ink-950 p-4 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] lg:hidden",

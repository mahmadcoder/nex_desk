    ...
    <>
      ...
      {!!upcoming.length && (
        <section className="mt-8">
          <h2 className="mono-tag mb-3">Upcoming</h2>
      ...
      {!!past.length && (
        <section className="mt-8">
          <h2 className="mono-tag mb-3">Past</h2>
          <div className="space-y-3">
            {past.map((m: any) => (
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1.5 flex flex-wrap items-center gap-x-2 text-sm text-bone-200">
            ...
            {/* "in 2 days" answers the question faster than a date does. */}
          ...
          {/* Written after the call, so it only appears on one that happened.
              Kept apart from the agenda rather than overwriting what was
              promised with what actually took place. */}
          {m.notes && (
            <div className="mt-3 rounded-lg border border-ink-600 bg-ink-800/50 p-3">
              <p className="mono-tag mb-1 text-[10px]">What we agreed</p>

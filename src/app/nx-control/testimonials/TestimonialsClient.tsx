...
export default function TestimonialsClient({ testimonials }: { testimonials: ITestimonial[] }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Confirm Delete Testimonial Modal */}
      <ConfirmModal
        isOpen={!!deletingId}
        title="Delete Client Testimonial"
        description="Are you sure you want to delete this testimonial? It will be removed from your website Testimonial Wall."
      ...
      {/* Confirm Seed Testimonials Modal */}
      <ConfirmModal
        isOpen={showSeedModal}
        title="Seed Default Testimonials"
        description="Are you sure you want to seed default agency client testimonials into the database?"

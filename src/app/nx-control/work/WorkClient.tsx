  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-ink-600 pb-6">
        <div>
          <span className="mono-tag text-lime-400">Portfolio CMS</span>
          <h1 className="mt-1 text-2xl font-semibold text-bone-50">Case Studies & Work ({caseStudies.length})</h1>
          <p className="mt-1 text-xs text-bone-400">Manage agency portfolio projects, metrics, and showcase work</p>
        </div>
